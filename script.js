...
const newQuestions = [
  ...
  ,
  {
    q: "------------ language use short meaningful words to represent its statements",
    options: ["High level", "Assembly", "Intermediate level", "Both B and C"],
    correct: 0,
    explanation: "High-level languages use readable, meaningful words."
  },
  {
    q: "In ------------, compiling and executing are two separate processes",
    options: ["Assembler", "Compiler", "Interpreter", "Either B or C"],
    correct: 1,
    explanation: "Compiler separates compile and execution stages."
  },
  {
    q: "---------- acts as a layer between .NET application and operating system",
    options: ["Visual Studio .NET", ".NET Framework", "C# .NET", "Other"],
    correct: 1,
    explanation: ".NET Framework acts as the intermediary layer."
  },
  {
    q: "Program used for detecting bugs in code",
    options: ["Compiler", "Editor", ".NET Framework", "Other"],
    correct: 0,
    explanation: "Compiler detects syntax errors."
  },
  {
    q: "Main method passed parameters to calMul by",
    options: ["reference", "value", "out", "id"],
    correct: 1,
    explanation: "Parameters are passed by value by default."
  },
  {
    q: "calMul method passed parameters to Mul by",
    options: ["reference", "value", "out", "id"],
    correct: 1,
    explanation: "Default passing is by value."
  },
  {
    q: "If out parameter is used when passing parameters to Mul method, the output will be",
    options: ["0, 0", "25, 125", "125, 25", "Compile Error"],
    correct: 1,
    explanation: "out allows method to modify values."
  },
  {
    q: "What is the value of switch operator i + j * k?",
    options: ["14", "9", "20", "12"],
    correct: 0,
    explanation: "Operator precedence gives result 14."
  },
  {
    q: "What is the final output?",
    options: ["1 3 1", "2 3 4", "5 3 4", "Error"],
    correct: 1,
    explanation: "Based on switch-case execution."
  },
  {
    q: "If break is removed from first case, output will be",
    options: ["1 3 1", "2 3 4", "5 3 4", "Error"],
    correct: 2,
    explanation: "Fall-through occurs without break."
  },
  {
    q: "If we add case 0 to the switch, output will be",
    options: ["1 3 1", "2 3 4", "5 3 4", "Error"],
    correct: 0,
    explanation: "Case 0 matches first."
  },
  {
    q: "If we add case x to the switch, output will be",
    options: ["1 3 1", "2 3 4", "5 3 4", "Error"],
    correct: 3,
    explanation: "x is not constant → compile error."
  },
  {
    q: "Main function is called many times as call(s) method",
    options: ["Incremental", "Iterative", "Recursive", "Single time"],
    correct: 2,
    explanation: "Method calls itself → recursion."
  },
  {
    q: "What will be the output of code segment #f?",
    options: ["hi", "hi hi", "Compile error", "Infinite execution"],
    correct: 3,
    explanation: "Recursive call without termination."
  },
  {
    q: "++ is a ______ operator",
    options: ["Unary", "Binary", "Ternary", "Other"],
    correct: 0,
    explanation: "++ works on one operand."
  },
  {
    q: "Initial value of variable i defined in line 3 is",
    options: ["0", "10", "11", "None of the above"],
    correct: 0,
    explanation: "i is initialized to 0."
  },
  {
    q: "Expression for(int i=0; i<=10;) defines a",
    options: ["variable", "loop", "conditional statement", "selection statement"],
    correct: 1,
    explanation: "for is a loop."
  },
  {
    q: "Expression while(true) defines a",
    options: ["variable", "infinite loop", "conditional statement", "selection statement"],
    correct: 1,
    explanation: "Condition always true."
  },
  {
    q: "Expression if(i > 5) defines a",
    options: ["variable", "infinite loop", "conditional statement", "recursion"],
    correct: 2,
    explanation: "if is a conditional statement."
  },
  {
    q: "How many times will line 7 be executed?",
    options: ["0", "Infinite", "11", "10"],
    correct: 2,
    explanation: "Loop runs from 0 to 10 inclusive."
  },
  {
    q: "How many times will line 10 be executed?",
    options: ["11", "6", "5", "Infinite"],
    correct: 1,
    explanation: "Condition becomes true 6 times."
  },
  {
    q: "How many times will line 15 be executed?",
    options: ["11", "6", "5", "Infinite"],
    correct: 2,
    explanation: "Executed when condition is met."
  },
  {
    q: "What is the result of executing line 19?",
    options: ["0", "51", "66", "None of the above"],
    correct: 1,
    explanation: "Accumulated sum equals 51."
  },
  {
    q: "What is the result of executing line 20?",
    options: ["0", "51", "66", "None of the above"],
    correct: 2,
    explanation: "Final calculated value is 66."
  },
  {
    q: "Result of executing line 20 if we swap lines 15 and 16?",
    options: ["0", "51", "15", "None of the above"],
    correct: 2,
    explanation: "Execution order affects result."
  }
